...
>[!Important]
This repo has been archived. The Grafana tsconfig package now lives at [https://github.com/grafana/plugin-tools/packages/tsconfig](https://github.com/grafana/plugin-tools/tree/main/packages/tsconfig)
